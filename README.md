...
|-------------|-------------------------------|
| **Stimuli** <br/> `()`, `(cls)`, `(obj)` |                                                                                 create multiple stimulus with associated reactions <br/>                                                                   empty, with reactions from class or object                                                                                   `EventEmitter event = new EventEmitter();` <br/>                                                                             `EventEmitter event = new EventEmitter(NetHandler.class);` <br/>                                                             `EventEmitter event = new EventEmitter(netHandlerObj);` |
